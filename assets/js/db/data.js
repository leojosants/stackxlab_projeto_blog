...
export const db = [
    {
        ...
        views_1: get_views_posts.adobe_firefly,
    ...
    },
    {
        ...
        views_2: get_views_posts.js,
        text_2: `<strong>JavaScript</strong> é uma linguagem de programação <strong>interpretada estruturada</strong>, de <strong>script</strong> em alto nível com <strong>tipagem dinâmica fraca</strong> e multiparadigma. Juntamente com HTML e CSS, o JavaScript é <strong>uma das três principais tecnologias</strong> da World Wide Web.<br />
    ...
    },
    {
        ...
        views_3: get_views_posts.google_glass,
    ...
    },
    {
        ...
        views_4: get_views_posts.hand_talk,
    ...
    },
    {
        ...
        views_5: get_views_posts.python,
        text_5: `Python é uma <strong>linguagem de programação de alto nível</strong>, interpretada de script, imperativa, orientada a objetos, funcional,<strong> de tipagem dinâmica e forte</strong>. Foi lançada por Guido van Rossum em 1991.<br />
    ...
    },
    {
        ...
        views_6: get_views_posts.smartwatch,
        text_6: `É um <strong>relógio de pulso computadorizado</strong> com funcionalidades que <strong>vão além de mostrar as horas</strong>, e é com frequência comparado aos assistentes digitais pessoais.<br />
    ...
    },
    {
        ...
        views_7: get_views_posts.php,
        text_7: `PHP é uma <strong>linguagem de programação interpretada livre</strong>, usada originalmente apenas para o <strong>desenvolvimento de aplicações</strong> presentes e atuantes<strong> no lado do servidor</strong>, capazes de gerar conteúdo dinâmico na World Wide Web.<br />
    ...
    },
    {
        ...
        que não necessite de <strong>pilotos embarcados</strong> para ser guiada.<br />
